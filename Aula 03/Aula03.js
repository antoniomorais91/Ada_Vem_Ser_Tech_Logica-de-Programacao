...
let parceirosPF = parceiros.filter((cpf) => {
    return cpf.parceirosId.length === 11;
})

let parceirosPJ = parceiros.filter((cnpj) => {
    return cnpj.parceirosId.length === 14;
})

const parceirosAgrupados = {PF: parceirosPF, PJ: parceirosPJ}
